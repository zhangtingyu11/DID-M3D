...
def send_email(easy, mod, hard, map, res):
    ...
    # 邮件内容
    subject = "使用LRRU的深度补全结果(去掉<2.0的深度, 另外一种attention"
    if res == 0:
...
if __name__ == "__main__":
    for idx in range(100):
        ...
        log_filename = '/home/public/zty/Project/DeepLearningProject/DID-M3D/work_dirs/kitti_models/logs/only_car_lrru_clip_transformer_encoder_another_attention_{}/train.log'.format(idx)
        if res == 0:
